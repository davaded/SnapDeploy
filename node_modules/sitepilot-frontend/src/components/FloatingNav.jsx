...
export function FloatingNav({ activeTab, onTabChange, onOpenSettings }) {
    ...
    return (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-40">
            <div className="flex items-center p-1.5 bg-white/80 backdrop-blur-xl border border-white/40 rounded-full shadow-soft hover:shadow-lg transition-shadow duration-300 ring-1 ring-black/5">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive ? "text-white" : "text-text-secondary hover:text-black"
                                )}
                            >
                                {isActive && (
                                    <motion.div
